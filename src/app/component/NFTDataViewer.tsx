...
export default function NFTDataViewer() {
    ...
    <div className="max-w-4xl mx-auto p-6 bg-gray-900 text-white">
      ...
      <div className="bg-gray-800 rounded-lg p-6 mb-6">
        ...
        <div className="text-sm text-gray-400">
          <p>
            💡 <strong>Tip:</strong> Open browser console to see detailed logs!
          </p>
          <p>
            🔧 <strong>Global Access:</strong> Use{" "}
            <code>QuickNFT.get(&apos;1&apos;)</code> in console
          </p>
        </div>
      </div>
  ...
  name: '${hookNFT.name}',
  description: '${hookNFT.description.substring(0, 50)}${
                    hookNFT.description.length > 50 ? "..." : ""
                  }',
              ...
              <div className="bg-gray-700 p-3 rounded mb-4 text-sm">
                <p className="text-yellow-400">
                  ...
                  {Array.isArray(fetchedData)
                    ? `Array[${fetchedData.length}]`
                    : "Single NFT"}
                </p>
                {Array.isArray(fetchedData) && (
                  <p className="text-blue-400">
                    🎯 Sample:{" "}
                    {fetchedData.length > 0 ? fetchedData[0].name : "No items"}
                  </p>
                )}
              </div>
              <pre className="bg-gray-900 p-4 rounded text-xs overflow-auto max-h-64">
      ...
      <div className="bg-gradient-to-r from-purple-900 to-blue-900 rounded-lg p-6 mt-6">
        ...
        <div className="text-sm space-y-2">
          ...
          <p>
            ...
            - Print NFT data nicely
          </p>
          <p>
            <code className="bg-black/30 px-2 py-1 rounded">
              QuickNFT.getSimple(&apos;1&apos;)
            </code>{" "}
